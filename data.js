...
//skill : basic(일반공격), skill(공명스킬), circuit(공명회로), liberation(공명해방), intro(변주)
//캐릭터
const characters = [
			...
			"first_skill" : "liberation", "second_skill" : "circuit", "third_skill" : "skill", "fourth_skill" : "basic", "fifth_skill": "intro",
			"skill bonus1" : "atk", "skill bonus2" : "glacio dmg",
			"KR_name" : "산화"},
