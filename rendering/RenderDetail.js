function createSelectOption(type, container) {
	console.log("createSelectOption-", type);
	
	//type에 따른 Option 선언
	let array;
	if(type === "Lv") array = [1, 20, 40, 50, 60, 70, 80, 90];
	else if(type === "Rank") array = [1, 2, 3, 4, 5, 6];
	...
	SelectOption.classList.add(type.toLowerCase());
...
function createCardSelectOption(type, container) {	
...
function createCardImg(type, name, container){
