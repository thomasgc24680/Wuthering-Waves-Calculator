...
export function initialCardGrid(){
	const currentTab = "character";
	
	const SelectCardGrid = document.getElementById("select-screen");
	SelectCardGrid.classList.add("tab-content");
	SelectCardGrid.innerHTML = "";
	
	Data.characterData.forEach(card => {
